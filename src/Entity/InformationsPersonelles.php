...
class InformationsPersonelles
{
    ...
    #[Groups(['persist.InformationsPersonelles', 'persist.InformationsPersonellesTemp'])]
    private $id;

    #[ORM\Column(type: 'string', length: 255, nullable: true)]
    #[Groups(['persist.Joueur', 'read.Joueur', 'persist.InformationsPersonelles' , 'persist.InformationsPersonellesTemp'])]
    private $nom_complet;
